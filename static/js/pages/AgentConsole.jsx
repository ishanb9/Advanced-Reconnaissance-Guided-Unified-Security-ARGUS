...
const AGENT_SUBAGENTS = {
  ...
  osint:   ['whois_recon', 'shodan_query', 'email_harvest', 'dns_history'],
...
const SUBAGENT_META = {
  ...
  whois_recon:        { icon: '🌐', label: 'WHOIS Recon'      },
  shodan_query:       { icon: '🔭', label: 'Shodan Query'     },
  email_harvest:      { icon: '📧', label: 'Email Harvest'    },
  dns_history:        { icon: '🗓',  label: 'DNS History'     },
